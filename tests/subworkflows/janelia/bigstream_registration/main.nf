...
workflow test_registration_no_additional_deformations {
    def meta = [
        id: 'test_registration_no_additional_deformations',
    ]
...
workflow test_registration_and_additional_deformations {
    def meta = [
        id: 'test_registration_and_additional_deformations',
    ]
