...
```
nextflow run ./tests/subworkflows/janelia/spark_cluster/main.nf -c tests/config/nf-test.config -c ./tests/subworkflows/janelia/spark_cluster/nextflow.config -profile podman --distributed true
```
